...
def _run_tyler_crew():
    """Run Tyler's CrewAI prospecting with trigger-event hunting and deep research."""
    task = Task(
        description=(
            "Search for local service businesses in the DFW 380 Corridor "
            "(Aubrey, Celina, Prosper, Pilot Point, Little Elm TX) that are experiencing "
            "TRIGGER EVENTS — moments of change that create buying urgency for an AI receptionist.\n\n"
            "TRIGGER EVENTS TO HUNT FOR:\n"
            "- Google reviews mentioning missed calls, slow response, voicemail complaints\n"
            "- Hiring for front desk or receptionist (they're overwhelmed)\n"
            "- New location opening or expansion (more calls, same staff)\n"
            "- Bad review streak (reputation damage from poor responsiveness)\n"
            "- Competitor with significantly better review count or rating\n"
            "- Seasonal demand approaching (summer AC rush, storm season for roofers)\n"
            "- New services added or recent renovation\n\n"
            "FOR EACH PROSPECT (find 3 high-quality targets):\n"
            "1. Search for the business and verify it's in the 380 Corridor\n"
            "2. Find the OWNER or decision-maker's FIRST AND LAST NAME\n"
            "3. Find their direct EMAIL address (search '[business] [city] TX owner email contact')\n"
            "4. Find the business PHONE NUMBER\n"
            "5. Find the business WEBSITE URL\n"
            "6. Find ONE specific, verifiable fact (Google review quote, years in business, "
            "number of reviews, specific service niche — NOT generic marketing copy)\n"
            "7. Identify the TRIGGER EVENT that makes NOW the right time to reach out\n"
            "8. Find what their closest COMPETITOR does better (review count, response time, online presence)\n\n"
            "DO NOT write cold emails. DO NOT draft subject lines. Your job is RESEARCH and QUALIFICATION only.\n"
            "GHL workflows handle all email sequences automatically.\n\n"
        ...
        expected_output=(
            "Structured prospect intelligence report with exactly 3 prospects.\n"
            "For EACH prospect, provide ALL of the following:\n"
            "- business_name: Full business name\n"
            "- business_type: e.g. 'HVAC', 'Plumbing', 'Roofing', 'Dental', 'Personal Injury Law'\n"
            "- city: City in DFW 380 Corridor\n"
            "- contact_name: Owner/decision-maker FIRST AND LAST name\n"
            "- email: Direct email address (REQUIRED — search for it)\n"
            "- phone: Business phone number\n"
            "- website: Business website URL\n"
            "- verified_fact: One specific, verifiable fact directly from web research\n"
            "- trigger_event: The specific trigger event making NOW the right time\n"
            "- competitive_insight: What their closest competitor does better\n"
            "- reason: Why this business needs an AI receptionist (2-3 sentences)\n\n"
            "DO NOT include cold emails, subject lines, or follow-up angles. "
            "Research and qualification ONLY."
        ),
        agent=tyler,
    )
...
def _run_ryan_data_crew():
    ...
    task = Task(
        description=(
            ...
            "- Declining Google reviews (complaints about response time, sales process)\n"
            "- Job posting for BDC roles (signal they're struggling with lead response)\n"
            "- Expansion, renovation, or new brand addition\n"
            "- Competitor dealership making digital moves or winning awards\n"
        ...
        expected_output=(
            "Structured prospect intelligence report with exactly 3 dealership prospects.\n"
            "For EACH prospect, provide ALL of the following:\n"
            ...
            "- group_affiliation: Dealership group if known, otherwise empty\n"
            "- verified_fact: One specific, verifiable fact directly from web research\n"
            "- trigger_event: The specific trigger event making NOW the right time\n"
            "- competitive_insight: What their closest competing dealer does better digitally\n"
            "- reason: Why this dealership needs an AI readiness assessment (2-3 sentences)\n\n"
            "DO NOT include cold emails, subject lines, or follow-up angles. "
            "Research and qualification ONLY."
        ),
        agent=ryan_data,
