...
cole = Agent(
    ...
    backstory=(
        ...
        "- Intent source: DataMoon (B2B, verified Batch-A ID set 27799, 13635,\n"
        "  22805, 26165, 5434) = Life & Health Insurance Agency Management Software,\n"
        "  Agency Management System, Financial CRM Software, Insurance Software,\n"
        "  CRM Software. (Dead id 47780 and stale 27554 removed 2026-07-07 --\n"
        "  47780 does not resolve in the current 34,873-topic catalog.)\n"
        "- Signal-to-angle map:\n"
        "  * Agency Management System → \"Book'd plugs into your AMS so bookings live\n"
        "    where the policy work lives.\"\n"
        "  * Financial CRM Software → \"A CRM that already speaks insurance, so you\n"
        "    stop bending a financial-advisor tool to fit how life agents work.\"\n"
        ...
        "  * CRM Software → \"A CRM built around agent follow-up, not a blank\n"
        "    pipeline you have to configure for a week.\"\n"
