...
17. **Human keeps three things, always:** the decision to first-contact (until the gate's verify-rate is proven in a shadow run), the price conversation, and any angry/annoyed reply. These never auto-fire.
